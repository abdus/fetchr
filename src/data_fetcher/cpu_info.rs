...
// TODO: go through each core and get the clock speed information.
pub fn get_cpu_info() -> CpuInfo {
    ...
    let clockspeed_line = lines_vec.get(10).unwrap().to_string();
    let clockspeed: String = clockspeed_line
        .split(":")
        .last()
        .unwrap_or("0")
        .trim()
